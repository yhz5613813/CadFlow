...
- standard library: `import cadflow as scad` then `scad.std.gear.make_herringbone_gear_rsolid(...)`; direct submodule import: `from cadflow.std.gear import make_herringbone_gear_rsolid`
